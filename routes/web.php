...
// The original landing page was a welcome screen generated by the
// Laravel frontend scaffolding.  We still keep the component around so that
// a fresh installation can view it once, but after the application has at
// least one user we want to bypass it entirely and send users straight to
// the login screen (or dashboard if they're already authenticated).
use App\Models\User;
use Inertia\Inertia;
